...
export class AccountsController {
  ...
  /**
   * Get All Clinics Manager By Clinic Admin Id (Admin)
   *
   * Retrieves a paginated list of all active clinics.
   * Only returns accounts with role: CLINIC_MANAGER and status: ACTIVE
   * Excludes soft-deleted records (deletedAt is null)
  ...
  async getAllClinicsManagerByClinicAdminId(
    ...
    const result =
      await this.accountsService.findAllClinicsManagerByClinicAdminId(
        id,
        page,
        limit,
        search,
