...
import {
  ...
  jsonbEncryptionTransformer,
} from '../../../common/transformers/encryption.transformer';
...
@Index('idx_doctor_information_account', ['accountId'])
@Index('idx_doctor_information_fullname', ['fullName'])
