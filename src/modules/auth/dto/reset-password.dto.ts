...
import { IsStrongPassword, Match } from 'src/common/validators/custom-validators';
...
export class ResetPasswordDto {
  ...
  @ApiProperty({
    description: 'New password (min 8 chars, must contain uppercase, lowercase, number, special character)',
