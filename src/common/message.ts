...
const successMessage = {
  ...
  // Password Management
  passwordResetCodeSentSuccess: 'Password reset code sent to your email. Code expires in 15 minutes. Please check your inbox.',
...
const failMessage = {
  ...
  oauthUserCannotResetPassword: 'OAuth users cannot reset password. Please login with your OAuth provider (Google, etc.)',
  // Ban/Status Errors
  ...
  noVerificationCodeFound: 'No verification code found or code has already been used. Please request a new one.',
  invalidVerificationCode: 'Invalid verification code. Please check and try again.',
  verificationCodeExpired: 'Verification code has expired. Please request a new one via POST /mailer/send-verification-code',
  verificationCodeAlreadyUsed: 'Verification code has already been used. Please request a new one.',
  noResetCodeFound: 'No reset code found or code has already been used. Please request password reset again.',
  invalidResetCode: 'Invalid reset code. Please check and try again.',
  resetCodeExpired: 'Reset code has expired (15 minutes). Please request password reset again.',
  resetCodeAlreadyUsed: 'Reset code has already been used. Please request a new one.',
  // Role/Permission Errors
  invalidPatientId: 'Provided patientId does not belong to a PATIENT role',
  onlyPatientCanChangeEmail: 'Only PATIENT accounts can change their email address. Other roles must contact administrator.',
  ...
  onlyPatientCanUpgradeToManager: 'Only PATIENT accounts can upgrade to CLINIC_MANAGER',
