...
| **5.2** | **Filter: Tìm kiếm theo tên** | • `working_date: '2026-02-25'`<br>• `search: 'Bonix'` | ✅ QueryBuilder.andWhere gọi với:<br>• `clinic.full_name ILIKE :search`<br>• `{ search: '%Bonix%' }` | • Support wildcard search<br>• Case-insensitive |
